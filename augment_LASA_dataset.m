...
for i=4:30
    ...
    for demoIt=demoNum   
        ...
        if(PLOT)
            ...
            figure(i)
            subplot(1,2,1)
            plot(demoVS{demoIt}.pos(1,:), demoVS{demoIt}.pos(2,:), 'color',colorGreen, 'LineWidth', 3)
            hold on

            subplot(1,2,2)
            hold on
            sDem = demoVS{demoIt}.feat;

            plot(sDem(1,:), sDem(2,:), 'color',colorGreen, 'LineWidth', 3)
            plot(sDem(3,:), sDem(4,:), 'color',colorGreen, 'LineWidth', 3)
            plot(sDem(5,:), sDem(6,:), 'color',colorGreen, 'LineWidth', 3)
            plot(sDem(7,:), sDem(8,:), 'color',colorGreen, 'LineWidth', 3)
        end
