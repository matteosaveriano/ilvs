...
if Vxf0.SOS
    ...
    Vxf.success = check_constraints(popt,ctr_handle,d,0,options);
else
    ...
    Vxf.d = Vxf0.d;
    Vxf.w = Vxf0.w;
    Vxf.success = check_constraints(popt,ctr_handle,d,Vxf.L,options);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function bool_success = check_constraints(p,ctr_handle,d,L,options)
...
% Remove text output to speed up
%if bool_success
